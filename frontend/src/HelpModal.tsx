  ...
  return (
    <div className="help-modal">
      <div className="help-modal-content">
        ...
        <p><span className="closeElement">Adjacent</span>: The guessed element is close to the element in today's secret movie. For actors, this means that they aren't in the MOTD, but have acted with an actor in the MOTD. For tags, this means that the tag is slightly relateed to the movie, but only has a relevancy score of .5-.7</p>
      </div>
    </div>
  );
};
